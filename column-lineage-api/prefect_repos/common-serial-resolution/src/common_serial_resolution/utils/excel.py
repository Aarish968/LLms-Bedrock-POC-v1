"""
This is directly copied from common_prefect_next/tasks/excel/excel.py

Maintained here to avoid pulling in prefect dependencies in common_serial_resolution
"""
